...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    // Hapus seluruh blok WidgetsBinding.instance.addPostFrameCallback
    // karena halaman sudah statis di PageProvider.
  }
    ...
    return MaterialApp(
      ...
      theme: context.watch<ProfileProvider>().isDark
          ? ThemeData.dark().copyWith(
              ...
              bottomSheetTheme:
                  BottomSheetThemeData(backgroundColor: Color(0xFF1E1E1E)),
          ...
          : ThemeData.light().copyWith(
              ...
              inputDecorationTheme: InputDecorationTheme(
                  enabledBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Color(0xFF1E1E1E), width: 1),
                      borderRadius: BorderRadius.circular(5)),
                  focusedBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Color(0xFF1E1E1E), width: 1),
